...
public class LoginFragment extends Fragment implements LoginPresenter.View {
    ...
    @BindView(R.id.login_username) protected EditText mUsernameEditText;
    @BindView(R.id.login_password) protected EditText mPasswordEditText;
    @BindView(R.id.login_save_username_toggle) protected Switch mSaveUsernameToggle;
    @BindView(R.id.login_button) protected Button mLogin;
    @BindView(R.id.new_account_text) protected TextView mNewAccountTextView;
